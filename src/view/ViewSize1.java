 ...
 * @author c
 */
public class ViewSize1 extends javax.swing.JFrame {
    ...
    public void fillSize(){
        ...
        for (Size size : nvlist) {
            dtm.addRow(new Object[]{size.getMa(),size.getSoSize(),size.getCannangmin(),size.getCanmangmax(),size.getChieucaomin(),size.getChieucaomax()});
        }
    }
    ...
    private void initComponents() {
        ...
        tb_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã", "Tên", "can nang min", "can nang max", "chieu cao min", "chieu cao max"
            }
        ));
        ...
        jLabel1.setText("chieu cao max");

        jLabel4.setText("chieu cao min");

        jLabel5.setText("can nang max");

        jLabel6.setText("can nang min");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(12, 12, 12)
                                .addComponent(txtcannangmin, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(34, 34, 34)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtchieucaomin, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel1)
                                .addGap(18, 18, 18)
                                .addComponent(txtchieucaomax, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)))
                        .addGap(90, 90, 90))))
        );
    ...
    private void btnADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnADDActionPerformed
        ...
        s.setCannangmin(Integer.parseInt(txtcannangmin.getText()));
        s.setCanmangmax(Integer.parseInt(txtcannangmax.getText()));
        s.setChieucaomin(Integer.parseInt(txtchieucaomin.getText()));
        s.setChieucaomax(Integer.parseInt(txtchieucaomax.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSize1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
