...
public class Menu extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    BanGiay11 banGiay11 = new BanGiay11();
    ...
    public void run() {
        ...
        do {
            ...
            if (result != null) {
                ...
                for (GioHang h : banGiay11.listGH) {
                    t = (int) (t + h.getGia());
                }
                //             float tiengiam = Float.valueOf(banGiay11.txtTienGiam.getText());
                //               float tienct = t - tiengiam;
//                banGiay11.txtTongTien.setText(String.valueOf(t));
//
//                banGiay11.txtTienCanTra.setText(String.valueOf(tienct));
//                // float tienKD = Float.valueOf(txtTienKD.getText());
//                // float tienThua = tienKD - tienct;
//                // txtTienThua.setText(String.valueOf(tienThua));
//                JCalendar jcalendar = new JCalendar();
//                banGiay11.ngaytao.setDate(jcalendar.getDate());
                banGiay11.loadGH();
                banGiay11.loadSP();
            }
        } while (true);
