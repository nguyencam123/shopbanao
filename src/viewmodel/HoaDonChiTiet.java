...
public class HoaDonChiTiet {
    ...
    public HoaDonChiTiet(String TenKH, Date NgayTao, Double TongTien, Double TienCanTra, Double TienKhachDua, Double TIenThua, String maKM, String maNV, String SDT) {
        this.TenKH = TenKH;
        this.NgayTao = NgayTao;
        this.TongTien = TongTien;
        this.TienCanTra = TienCanTra;
