...
public class Menu1 extends javax.swing.JPanel {
    ...
    private void initMenu() {
        addMenu("Bán Hàng", "1", 0);
   //     addMenu("Nhân Viên", "2", 1);
        addMenu("Hóa Đơn", "3", 1);
   //     addMenu("Sản Phẩm", "4", 2);
//        addMenu("Thống Kê", "5", 4);
//        addMenu("Khuyến Mãi", "6", 5);
        addMenu("Cài Đặt", "7", 2);
        addMenu("Đổi Mật Khẩu", "8", 3);
        addMenu("Đăng Xuất", "9", 4);
//        addMenu("Đăng Xuất", "10", 5);
        //  add more menu here
        menu.repaint();
        menu.revalidate();
        setSelectedMenu(0);
        ...
        m.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (index != selectedIndex) {
                    ...
                    target = new PropertySetter(Menu1.this, "selectedLocation", selectedLocation, targetLocation);
    ...
    private void initComponents() {
        ...
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/JINGOO - 2022 _ 그래피티 캐릭터, 그래픽 일러스트, 일러스트레이션.png"))); // NOI18N
